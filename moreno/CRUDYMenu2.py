...
def todo():
    ...
    if ingrese==2:
        def modificar(tabla):
            try:
                ...
                print("tienes algun error al ingresar los datos")
        modificar('tb_reserva')
    if ingrese==3:
        try:
            e=input("ingrese el num_reserva que desea eliminar: ")
            ...
            eliminar('tb_reserva','num_habitacion')
    ...
    if ingrese==4:
        try:
            ...
            p=input("ingre el dato a insertar en el campo num_habitacion: ")
